...
@Component("demcDao")
public class DemcDaoImpl extends SuperDao implements DemcDao {
	...
	@Override
	public List<DrawData> querydata(final String sql)
	{
		System.out.println("aaaaa"+sql);
		List<DrawData> list = null;
		list = (List<DrawData>) getHibernateTemplate().execute(new HibernateCallback(){
			@Override
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
				// TODO Auto-generated method stub
	...
	@Override
	public DemandCollect get(String id) {
		// TODO Auto-generated method stub
		return (DemandCollect) getHibernateTemplate().get(DemandCollect.class, id);
	}
