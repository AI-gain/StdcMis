...
public class ShowDemandManagerImpl implements ShowDemandManager {
	...
	@Override
	public List<DrawData> querydata(String sql)
	{
		List<DrawData> list = null;
		System.out.println("aaaa");
		list = demcDao.querydata(sql);
		return list;
	}
	...
	public DemcDao getDemcDao() {
		return demcDao;
	}

	@Resource
	public void setDemcDao(DemcDao demcDao) {
