...
<html>
  ...
  <body>
  <form action="FormAudit/saveAudit.action?status=form&id=<%=dc.getDemandId() %>" target='frmmain' method="post">
    <table width="80%" border="1" align="center">
  	  ...
  	  <tr>
    	<td>表单状态</td>
    	<td colspan="5">需求待审核</td>
  	  </tr>
  	  <%
  	  }
  	  else if(dc.getDStatus()==2)
  	  {
  	  %>
  	  <tr>
    	<td>表单状态</td>
    	<td colspan="5">技术审核未通过</td>
  	  </tr>
  	  <tr>
  	  	<td>未通过原因</td>
  	  	<td colspan="5"><%=dc.getFormIdea() %></td>
  	  </tr>
  	  <%
  	  }
  	  else if(dc.getDStatus()==3)
  	  {
  	  %>
  	  <tr>
    	<td>表单状态</td>
    	<td colspan="5">等待部门审核</td>
  	  </tr>
  	  <tr>
  	  	<td>部门审核单位</td>
  	  	<td colspan="5"><%=dc.getManageDepart() %></td>
  	  </tr>
  	  <%
  	  }
  	  else if(dc.getDStatus()==4)
  	  {
  	  %>
  	  <tr>
    	<td>表单状态</td>
  	  ...
  	  <tr>
  	  	<td>未通过原因</td>
  	  	<td colspan="5"><%=dc.getDepartIdea() %></td>
  	  </tr>
  	  <%
  	  }
  	  else
