...
<table class="table" border="1" >
    ...
    <tr class="tr3">
        <td colspan="5">
        <textarea class="textarea" onkeyup="showTextLength('text1','theme')" id="theme" name="theme" cols=100 rows=6></textarea>
        </td>
    </tr>
     <tr class="tr2">
    ...
    <tr class="tr3">
        <td colspan="5">
        <textarea class="textarea" onkeyup="showTextLength('text2','tech-key')" id="techkey" name="techkey" cols=100 rows=6></textarea>
        </td>
    </tr>
     <tr class="tr2">
    ...
    <tr class="tr3">
        <td colspan="5">
        <textarea class="textarea" onkeyup="showTextLength('text3','target')" id="target" name="target" cols=100 rows=6></textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <label><input type="radio" name="model" value="技术推广与科技服务" onClick="Show('otherModel')">其他<input class="input5" type="text" id="otherModel" name="model" style="display:none;"></label>
        </td>
    </tr>
    <tr>
        <td class="td1"></td>
    ...
    <tr>
        ...
        <td colspan="4">
        <label><input type="radio" name="type" value="基础研究" onclick="getUI()">基础研究</label>
        <label><input type="radio" name="type" value="应用研究" onclick="getUI()">应用研究</label>
        <label><input type="radio" name="type" value="试验发展" onclick="getUI()">试验发展</label>
        <br>
        <label><input type="radio" name="type" value="研究发展与应用成果" onclick="getUI()">研究发展与应用成果</label>
        <label><input type="radio" name="type" value="技术推广与科技服务" onclick="getUI()">技术推广与科技服务</label>
        <label><input type="radio" name="type" value="生产性活动" onclick="getUI()">生产性活动</label>
        </td>
    </tr>
